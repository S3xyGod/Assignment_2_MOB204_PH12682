...
public class AdapterTopBooks extends BaseAdapter implements Filterable {
    ...
    public AdapterTopBooks(Activity context, List<Sach> arraySach) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.one_book, null);
