...
public class AdapterTheLoai extends BaseAdapter {
    ...
    public AdapterTheLoai(Activity context, List<TheLoai> arrayTheLoai) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.one_the_loai, null);
        ...
        if (position % 3 == 0) {
            ...
            holder.img.setImageResource(R.drawable.book_stack);
        } else {
            holder.img.setImageResource(R.drawable.book_stack_2);
        }
