...
public class ListBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lv_theLoai);
        ...
        adapterTheLoai = new AdapterTheLoai(ListBooksActivity.this, R.layout.one_the_loai, ArrLstSach);
        listView.setAdapter(adapterTheLoai);
